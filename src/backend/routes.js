...
router.get(
  "/patient/get_unprocessed_requests",
  PatientControllers.getUnprocessedRequests
);
router.get(
  "/patient/get_authorized_professionals",
  PatientControllers.getAuthorizedProfessionals
);

//professonal data routes
router.get("/professional/get_profile", ProfessionalControllers.getProfile);
router.get(
  "/professional/view_patient_file",
  ProfessionalControllers.viewPatientFile
);
router.post(
  "/professional/request_access",
  ProfessionalControllers.requestAccess
);
router.get(
  "/professional/get_pending_requests",
  ProfessionalControllers.getPendingRequests
);
